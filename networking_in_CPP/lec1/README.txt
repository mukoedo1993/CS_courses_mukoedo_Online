...
Final conclusions for part 1 video:
Here, we have already gotten a nice framework with an established messaging system and
queues through which we could start doing these transactions.
But, at the moment we have only been taking a really high level of problems we are going to
solve at the next couple of videos.